            ...
            while (true)
            {
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        //ArraySegment<Byte> arraySegmentByteBuffer = new ArraySegment<Byte>(new byte[0x1000], 0, 0x1000);
                        //await _listener.ReceiveFromAsync(arraySegmentByteBuffer, _listener.LocalEndPoint);
